 ...
 */
 ...
 add_action( 'add_meta_boxes', 'freedom_add_custom_box' );
/**
 * Add Meta Boxes.
 */ 
function freedom_add_custom_box() {
	// Adding layout meta box for page
	add_meta_box( 'page-layout', __( 'Select Layout', 'freedom' ), 'freedom_page_layout', 'page', 'side', 'default' ); 
	// Adding layout meta box for
	add_meta_box( 'page-layout', __( 'Select Layout', 'freedom' ), 'freedom_page_layout', 'post', 'side', 'default' ); 
}
...
$page_layout = array(
							'default-layout' 	=> array(
														'id'			=> 'freedom_page_layout',
														'value' 		=> 'default_layout',
														'label' 		=> __( 'Default Layout', 'freedom' )
														),
							'right-sidebar' 	=> array(
														'id'			=> 'freedom_page_layout',
														'value' 		=> 'right_sidebar',
														'label' 		=> __( 'Right Sidebar', 'freedom' )
														),
							'left-sidebar' 	=> array(
														'id'			=> 'freedom_page_layout',
														'value' 		=> 'left_sidebar',
														'label' 		=> __( 'Left Sidebar', 'freedom' )
														),
							'no-sidebar-full-width' => array(
															'id'			=> 'freedom_page_layout',
															'value' 		=> 'no_sidebar_full_width',
															'label' 		=> __( 'No Sidebar Full Width', 'freedom' )
															),
							'no-sidebar-content-centered' => array(
															'id'			=> 'freedom_page_layout',
															'value' 		=> 'no_sidebar_content_centered',
															'label' 		=> __( 'No Sidebar Content Centered', 'freedom' )
															)
						);
...
add_action('pre_post_update', 'freedom_save_custom_meta'); 
/**
 * save the custom metabox data
 * @hooked to pre_post_update hook
 */
function freedom_save_custom_meta( $post_id ) { 
	global $page_layout, $post; 
